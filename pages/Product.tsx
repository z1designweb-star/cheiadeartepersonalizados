        ...
        <div className="flex flex-col">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-8 border-t border-gray-100">
            <div className="flex flex-col items-center text-center">
              ...
              <span className="text-xs font-semibold text-gray-500 uppercase">Entrega Rápida</span>
            </div>
            <div className="flex flex-col items-center text-center">
              <ShieldCheck className="w-6 h-6 text-gray-400 mb-2" />
              <span className="text-xs font-semibold text-gray-500 uppercase">Pagamento Seguro</span>
            </div>
            <div className="flex flex-col items-center text-center">
              <RefreshCcw className="w-6 h-6 text-gray-400 mb-2" />
              <span className="text-xs font-semibold text-gray-500 uppercase">7 dias p/ Troca</span>
            </div>
          </div>
        </div>
      </div>
